...
const Weather = () => {
    ...
    const search = async (city) => {
        ...
        try{
            ...
            const response = await fetch(url); // This is a promise which will return the response from the server

            const data = await response.json(); // This is also a promise which will return the data in JSON format
